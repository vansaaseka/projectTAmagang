                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif ($data->status === 'proses validasi')
                                            @if ($data->verified === 'approve' && $data->surat_pengantar !== null)
                                                <button class="badge badge-secondary border-0 text-dark" data-toggle="modal"
                                                    data-id="{{ $data->id }}"
                                                    data-target="#UploadFileModal{{ $data->id }}">Proses Validasi
                                                    Pimpinan SV</button>
                                            @else
                                        ...
                                        @elseif ($data->status === 'siap download')
                                            <a href="" class="badge badge-success border-0 text-light">Siap
                                                Download</a>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('datapengajuan.approve', $data->id) }}" method="POST"
                                            class="d-inline" id="approveForm{{ $data->id }}">
                                            @csrf
                                            @method('PUT')
                                        ...
                                        @if ($data->verified == 'approve' && $data->status !== 'siap download' && $data->status !== 'magang selesai')
                                        ...
                                        <div class="modal fade" id="UploadFileModal{{ $data->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="editModalLabel">Upload Surat Pengantar
                                                            dan Proposal</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <form id="editForm"
                                                            ...
                                                            <div class="form-group">
                                                                <label for="proposal">Proposal Mahasiswa</label>
