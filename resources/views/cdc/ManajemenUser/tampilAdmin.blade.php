                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal"
                            data-target="#modalTambahAdmin">Tambah User</button>
                    </div>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form id="formTambahAdmin" action="{{ route('dataadmin.store') }}" method="POST"
                            ...
                            <table id="basic-table" class="table table-striped mb-0" role="grid">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($admin as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-sm btn-icon btn-primary mr-2" data-toggle="modal"
                                                    data-target="#modalEditAdmin{{ $data->id }}">
                                                ...
                                                <form action="{{ route('dataadmin.delete', $data->id) }}" method="POST"
                                        ...
                                        {{-- Modal Edit --}}
                                        <div class="modal fade" id="modalEditAdmin{{ $data->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="modalEditAdminLabel{{ $data->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="modalEditAdminLabel{{ $data->id }}">Edit Data Admin
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Form Edit Admin -->
                                                        <form id="formEditAdmin{{ $data->id }}"
                                                            action="{{ route('dataadmin.update', ['id' => $data->id]) }}"
    ...
    <script>
        $(function() {
            $('.toggle-status').change(function() {
                ...
                $.ajax({
                    url: '{{ route('dataadmin.ubahstatus', '') }}/' + id,
                    method: 'GET',
                    data: {
                        _token: '{{ csrf_token() }}',
                        status: status
