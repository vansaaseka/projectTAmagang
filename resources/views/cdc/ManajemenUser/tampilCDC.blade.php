                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-success" data-toggle="modal"
                            data-target="#modalTambahTimCDC">Tambah User</button>
                    </div>

                    {{-- Modal Tambah --}}
                    <div class="modal fade" id="modalTambahTimCDC" tabindex="-1" role="dialog"
                        aria-labelledby="modalTambahTimCDCLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form id="formTambahTimCDC" action="{{ route('datatimcdc.store') }}" method="POST"
                            ...
                            <table id="timcdcTable" class="table table-striped mb-0" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($timcdc as $data)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <button class="btn btn-sm btn-icon btn-primary mr-2" data-toggle="modal"
                                                    data-target="#modalEditTimCDC{{ $data->id }}">
                                                ...
                                                <form action="{{ route('datatimcdc.delete', $data->id) }}" method="POST"
                                        ...
                                        {{-- Modal Edit --}}
                                        <div class="modal fade" id="modalEditTimCDC{{ $data->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="modalEditTimCDCLabel{{ $data->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="modalEditTimCDCLabel{{ $data->id }}">Edit Data CDC
                                                        </h5>
                                                    ...
                                                    <div class="modal-body">
                                                        <!-- Form Edit CDC -->
                                                        <form id="formEditTimCDC{{ $data->id }}"
                                                            action="{{ route('datatimcdc.update', ['id' => $data->id]) }}"
    ...
    <script>
        $(function() {
            $('.toggle-status').change(function() {
                ...
                $.ajax({
                    url: '{{ route('datatimcdc.ubahstatus', '') }}/' + id,
                    method: 'GET',
                    data: {
                        _token: '{{ csrf_token() }}',
                        status: status
