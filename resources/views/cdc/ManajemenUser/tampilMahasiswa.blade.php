                            ...
                            <div class="modal-body">
                                ...
                                <form id="formTambahMahasiswa" action="{{ route('datamahasiswa.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="Masukkan Nama Mahasiswa" required autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Masukkan Email Mahasiswa" required autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        <label for="nim">NIM</label>
                                        <input type="text" class="form-control" id="nim" name="nim" placeholder="Masukkan NIM Mahasiswa" required autocomplete="off">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form id="formEditMahasiswa{{ $data->id }}" action="{{ route('datamahasiswa.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="nim">NIM</label>
                                                        <input type="text" class="form-control" id="nim" name="nim" value="{{ $data->nim }}" autocomplete="off">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="prodi_id" class="form-control">
                                                            <option value="">-- Pilih Prodi --</option>
                                                            @foreach ($prodi as $unit)
                                                            <option value="{{ $unit->id }}" {{ $data->prodi_id == $unit->id ? 'selected' : '' }}>
